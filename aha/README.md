...
### 💰 Risk Management
- **1% Risk per Trade** - ریسک ثابت در هر معاملە
- **Fixed Lot Size** - 0.01 Lot
- **Auto Lot Calculator** - محاسبه خودکار Lot بر اساس ریسک
- **Position Management** - حد اکثر 2 معاملە باز در هر نماد
...
### 1. Detection Phase
- بوت S/R levels را در آخر��ن 20 شمعدان تشخیص می دهد
...
| TradeSymbols | XAUUSD,BTCUSD | نمادهای تریدج |
...
SNRZ Bot MT5 © 2026 - All Rights Reserved
